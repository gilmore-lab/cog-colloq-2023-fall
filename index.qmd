...
![Source: <https://www.southmiamirecovery.com/wp-content/uploads/2020/07/Picture1-300x240.png>](https://www.southmiamirecovery.com/wp-content/uploads/2020/07/Picture1-300x240.png){fig-align="center"}
...
- Data sharing is good
    ...
    - Shared data and wrote (new) code for both vision tasks (and shared it, too).
:::
...
- [R Markdown](https://rmarkdown.rstudio.com) & [Quarto](https://quarto.org) especially powerful tools for 'literate programming' [@knuth_undated-mi; @Knuth1984-ot] : combining text, links, images, code, analyses into HTML, PDF, .docx, .pptx, documents or websites.
  - Consider joining our [Quarto Qrew](https://penn-state-open-science.github.io/quarto-qrew).
- [Jupyter notebooks](https://jupyter.org/) also great; see Mike Burnham's workshop at the [Open Science Bootcamp](https://penn-state-open-science.github.io/bootcamp-2023/day_2.html#day_2_pm_session_4).
...
- Quick (& dirty) is, well...
  - But you need to curate and conduct QA anyway, don't you?
- Pay now (gradually) or pay (a lot) later...
:::
...
## Lesson: Opening the file drawer
...
- Extensive (and openly shared) quality assurance protocols [@Soska2021-mh]
...
- [Databrary.org](https://databrary.org) data library
    ...
    - Share openly, but not publicly, with restricted community of researchers^[Better for data about people even if de-identified.] who are [authorized](https://databrary.org/about/agreement.html) by their institutions.
...
- Preregister
- Embed quality assurance checks & data curation into your workflows
...
::: {.incremental}
- What if we all shared our IRB and task protocols?
- What if *all* honors' theses or first year projects were pre-registered replication studies with open materials, and were documented via a preprint published on [PsyArXiv](https://psyarxiv.com) [e.g., @Frank2012-fc]?
- What if the typical masters was a [registered report](https://www.cos.io/initiatives/registered-reports)?
...
- Psychological laws
    ...
    - Cognitive biases: Undermine rationality (including scientific inference); Must guard against, see [@munafo_manifesto_2017]
- Construct validity
...
The HTML slides are hosted in a [GitHub repo](https://github.com/gilmore-lab/cog-colloq-2023-fall) and served by the GitHub pages service at the following URL: 
