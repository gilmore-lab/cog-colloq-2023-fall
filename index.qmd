...
- Example: [Gender](https://databrary.github.io/analytics/participant-demographics.html#gender)
...
- Sex differences ($M>F$) in vision [@Shaqiri2018-ys]: especially contrast sensitivity [@Abramov2012-da], motion sensitivity [@Murray2018-vn; @Qian2021-eu].
...
- Replications are good
    - And uncommon
    - More commonplace prior data sharing (by others) would have really helped
:::
...
- R Markdown & Quarto especially useful tools.
...
## Internal $\psi_{internal}$ states not directly observable, but...
...
>If it was fun, they wouldn't have to pay you to do it.
>
>*But now that it's more fun, they still should pay you. Especially now you have my new great-grandson to love and support...*
