...
- What is the logical, *physical* status of internal psychological states ($\Phi\leftarrow\rightarrow\Psi$)?
...
- Replications are good
    - And sadly uncommon
    - More commonplace prior data & materials sharing (by others) would have really helped.
    - Bigger (combined) samples $\rightarrow$ higher power to detect smaller effects.
    - Didn't ask, but shouldn't have to; most authors don't share even when asked [@Watson2022-ox; @Gabelica2022-nt; @Tedersoo2021-ad; @Vanpaemel2015-zr; @Wicherts2006-de] **even by a journal editor** [Miyakawa2020-wu].
...
>...Assuming a realistic range of prior probabilities for null hypotheses, false report probability is likely to exceed 50% for the whole (psychology and cognitive neuroscience) literature. In light of our findings, the recently reported low replication success in psychology is realistic, and worse performance may be expected for cognitive neuroscience. [@Szucs2017-fc]
...
- Psychological laws
    ...
    - Cognitive biases: Must be guarded-against, see [@munafo_manifesto_2017]
- Construct validity
    - Need more, better, widely shared documentation about what was asked, by whom, in what context...
