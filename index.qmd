...
- Quick (& dirty) is, well...
  - But you need to curate and conduct QA anyway
...
- [Databrary.org](https://databrary.org) data library
    ...
    - Share openly, but not publicly, with restricted audience of researchers^[Better for data about people even if de-identified.]
...
::: {.incremental}
- What if we all shared our IRB protocols?
- What if *all* first year projects were pre-registered replication studies with open materials, and were documented via a preprint published on [PsyArXiv](https://psyarxiv.com), cf [@Frank2012-fc]?
