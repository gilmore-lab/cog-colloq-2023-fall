...
- Power *curve* analyses (different $n$'s, effect sizes) informative and useful
...
![](include/img/336-contrast-staircase)
...
![](include/img/336-motion-staircase)
...
![](include/img/350-contrast-staircase)
...
![](include/img/350-motion-staircase)
...
![](include/img/393-contrast-staircase)
...
![](include/img/393-motion-staircase)

:::

::::

## Internal $\psi$ states not directly observable, but...
...
- You *can* learn to code, but do so in the context of solving a specific problem
    - Quarto Qrew
- Strive for *methods* reproducibility [@Goodman2016-fi]
    - Transparent to you $\rightarrow$ transparent to others
    - Reproducible for you $\rightarrow$ reproducible for others
- Replicate and/or simulate; visualize early and often
- Preregister
