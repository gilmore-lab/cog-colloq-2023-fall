...
### Crisis #2b: Construct validity & measurement
...
::: {.incremental}
- Don't fully understand relationship between sample size, power, and effect size? See [this exercise](https://psu-psychology.github.io/psych-490-reproducibility-2023-fall/ex05-apes.html) and [this app](https://rogilmore.shinyapps.io/PSYCH490-2023-APES/).
- Internally reproducible workflows $\rightarrow$ easier to share
...
- Open sciences practices take time and effort
- Quick (& dirty) is, well...
